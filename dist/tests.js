...
exports.testDocumentation = exports.testHealthCheck = exports.testMultipleBeneficiaries = exports.testInvalidApprovals = exports.testInvalidTokenAddress = exports.testPastMaturityDate = exports.testInvalidShares = exports.testMismatchedLengths = exports.testValidDeployment = void 0;
exports.runApiTests = runApiTests;
// Example test cases for the API
// Test 1: Valid deployment with minimum required parameters
exports.testValidDeployment = {
...
exports.testInvalidTokenAddress = {
...
exports.testMultipleBeneficiaries = {
 ...
 */
async function runApiTests(baseUrl = 'http://localhost:3000') {
    console.log('🧪 Running FundManager API Tests\n');
    const testCases = [
        { ...exports.testHealthCheck, endpoint: baseUrl + exports.testHealthCheck.endpoint },
        { ...exports.testDocumentation, endpoint: baseUrl + exports.testDocumentation.endpoint },
