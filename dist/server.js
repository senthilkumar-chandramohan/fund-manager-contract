...
const FundManager_json_1 = __importDefault(require("../artifacts/contracts/FundManager.sol/FundManager.json"));
...
function validateDeploymentParams(params) {
    ...
    if (!ethers_1.ethers.isAddress(params.tokenAddress)) {
...
app.post('/deploy', async (req, res) => {
    try {
        ...
        const contractFactory = new ethers_1.ethers.ContractFactory(FundManager_json_1.default.abi, FundManager_json_1.default.bytecode, signer);
